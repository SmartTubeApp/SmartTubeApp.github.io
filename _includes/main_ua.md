...
#### SmartTube — це медіаклієнт з відкритим кодом для Android TV з розширеними функціями відтворення та перегляду контенту.
...
#### [Завантажити apk](https://github.com/yuliskov/SmartTube/releases/latest)
